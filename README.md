...
첫 프로젝트를 마무리하고 돌아보니 좋은 사람들과 열심히 달려온 약 세달간의 여정에서 배운것도 많고 아쉬움도 많이 남았지만 그럼에도 뿌듯함이 앞서는 값진 결과를 얻었다.
회사생활을 하며 데이터 분석을 접하게 되며 처음으로 흥미로운 분야가 생겼다. 데이터 분석 스킬 향상을 위해 부트캠프를 시작하였고 데이터 분석 분만 아니라 Front-End, Back-End를 접하게 되며 시야가 넓어졌다. 
첫 프로젝트를 진행하며 Front-End, Back-End를 담당하게 되었다. 처음 접하는 스킬과 툴을 사용하며 스스로의 부족함도 많이 느꼈지만 팀원들과의 원활한 커뮤니케이션과 멘토님과 교수님의 지도아래 기한안에 만족스로운 결과물을 얻을 수 있었다. 
